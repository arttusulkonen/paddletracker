...
export default function RoomsPage() {
  ...
  // --- 3. Filter Rooms ---
  const { myRooms, communityRooms } = useMemo(() => {
    ...
    filtered.forEach((r) => {
      // Если у комнаты есть ID сообщества, она идет в Community tab
      if (r.communityId) {
        comm.push(r);
      } else {
        my.push(r);
    ...
    return { myRooms: my, communityRooms: comm };
  }, [allRooms, searchTerm]);

  // --- 4. Permissions ---
  // Ghost players cannot create rooms
          ...
          <TabsContent value='my' className='space-y-6'>
            {isLoadingRooms ? (
              ...
              <EmptyState
                ...
                description={t('Create a room to start playing with friends.')}
              />
            )}
          </TabsContent>
