            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button variant="ghost" className="relative h-10 w-10 rounded-full">
                  ...
                  {reqCount > 0 && (
                    <span
                      className="absolute -top-0.5 -right-0.5 z-10 flex h-4 min-w-4
                                 items-center justify-center rounded-full bg-destructive
                                 px-0.5 text-[10px] font-medium leading-none text-background"
                    >
                      {reqCount}
                    </span>
                  )}
                  <Avatar className="relative z-0 h-9 w-9">
                    ...
                    <AvatarFallback>
                      {user.name ? user.name[0].toUpperCase() : <UserCircle />}
                    </AvatarFallback>
                  </Avatar>
                </Button>
              </DropdownMenuTrigger>
